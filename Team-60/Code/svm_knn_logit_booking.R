...
# booking_changes, distribution_channel, customer_type, and hotel
...
# Minimum misclassification rate: 0.164614
...
# 
# Number of Support Vectors : 8366 
# 
# Objective Function Value : -5605978 
# Training error : 0.166476 
# Cross validation error : 0.194773 
...
kknn.tuned <- kknn(is_canceled ~ deposit_type + previous_cancellations + 
                     ...
                     distribution_channel + customer_type,
                   train=train_data, 
                   test=test_data, k = 48, scale = TRUE)
# stop the timer
end_time <- Sys.time()
...
glm_model = glm(is_canceled ~ deposit_type + previous_cancellations + 
                  lead_time + total_of_special_requests + 
                  market_segment +required_car_parking_spaces + booking_changes +
                  distribution_channel + customer_type, data=train_data,
                family='binomial')
summary(glm_model)
...
# -5.7658  -0.7463  -0.4581   0.1857   3.3812  
# 
# Coefficients:
#   Estimate Std. Error z value Pr(>|z|)    
# (Intercept)                   -1.814e+00  2.031e-01  -8.934  < 2e-16 ***
#   deposit_typeNon Refund         5.665e+00  1.391e-01  40.734  < 2e-16 ***
#   deposit_typeRefundable         4.664e-02  2.480e-01   0.188 0.850787    
# previous_cancellations         1.523e+00  5.046e-02  30.177  < 2e-16 ***
#   lead_time                      4.520e-03  1.033e-04  43.748  < 2e-16 ***
#   total_of_special_requests     -7.225e-01  1.354e-02 -53.378  < 2e-16 ***
#   market_segmentComplementary   -3.850e-01  2.668e-01  -1.443 0.149001    
# market_segmentCorporate       -5.535e-01  2.024e-01  -2.734 0.006258 ** 
#   market_segmentDirect           2.556e-01  2.232e-01   1.145 0.252084    
# market_segmentGroups          -1.355e-02  2.112e-01  -0.064 0.948830    
# market_segmentOffline TA/TO   -6.319e-01  2.119e-01  -2.982 0.002863 ** 
#   market_segmentOnline TA        9.114e-01  2.109e-01   4.321 1.55e-05 ***
#   required_car_parking_spaces   -2.534e+01  4.379e+01  -0.579 0.562778    
# booking_changes               -3.615e-01  1.773e-02 -20.384  < 2e-16 ***
#   distribution_channelDirect    -3.637e-01  1.089e-01  -3.338 0.000843 ***
#   distribution_channelGDS       -1.015e+00  2.534e-01  -4.003 6.25e-05 ***
#   distribution_channelTA/TO      1.742e-01  8.397e-02   2.074 0.038041 *  
#   distribution_channelUndefined  9.724e+00  3.956e+03   0.002 0.998039    
# customer_typeGroup            -3.246e-01  1.839e-01  -1.765 0.077643 .  
# customer_typeTransient         5.909e-01  5.844e-02  10.110  < 2e-16 ***
#   customer_typeTransient-Party   1.118e-01  6.192e-02   1.806 0.070905 .  
# ---
#   Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
# 
# (Dispersion parameter for binomial family taken to be 1)
# 
# Null deviance: 109813  on 83227  degrees of freedom
# Residual deviance:  73483  on 83207  degrees of freedom
# AIC: 73525
# 
